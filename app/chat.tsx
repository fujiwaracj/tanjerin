        ...
        <div className="mx-auto flex h-full flex-col md:h-fit lg:max-w-screen-xl lg:px-8">
            <div className="h-full gap-x-4 md:h-fit lg:flex-row">
                <div className="z-10 mx-auto flex h-full flex-col justify-between lg:rounded-lg  lg:py-2 lg:shadow md:mt-4 md:h-fit lg:max-w-screen-sm">
                    ...
                    <form onSubmit={handleSubmit} className="grid gap-y-4 border-t px-4 border-orange-200 py-2">
                        <textarea
                            className="inline-flex min-h-48 rounded-md border border-orange-200 px-3 py-1.5 text-xl font-medium text-orange-800 outline-2 outline-offset-2 placeholder:text-orange-800/50 focus-visible:outline-orange-200"
                            value={input}
                        ...
                        {isLoading ? (
                            <button
                                type="button"
                                onClick={stop}
                                className="h-9 rounded-md border border-orange-200 px-3  py-1.5 font-medium text-orange-900 focus-visible:outline focus-visible:outline-orange-200"
                            >
                                Stop
                            </button>
                        ) : (
                            <button
                                type="submit"
                                className="h-9 rounded-md border bg-orange-100 border-orange-200 px-3  py-1.5 font-medium text-orange-900 focus-visible:outline focus-visible:outline-orange-200"
                            >
                                Submit
                            </button>
                        )}
